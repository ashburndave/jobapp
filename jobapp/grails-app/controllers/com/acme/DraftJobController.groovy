...
class DraftJobController {
  ...
  def list(Integer max) {
    ...
    [jobInstanceList: DraftJob.list(params), jobInstanceTotal: DraftJob.count()]
  }

  def create() {
    [jobInstance: new DraftJob(params)]
  }

  def save() {
    def jobInstance = new DraftJob(params)
  ...
  def show(Long id) {
    def jobInstance = DraftJob.get(id)
    if (!jobInstance) {
